...
// sin 90 derece 1'e eşittir ama programlamada dereceyle değil radyanla işlem yapılır. 90 derece = PI/2
console.log(Math.sin(Math.PI / 2)); //1

// ondalıklı kısmının uzunluğunu belirleme
let p = 1.5;
console.log(p.toFixed(2)); //1.50
console.log(Math.PI.toFixed(3)); //3.142

let r = 2.119;
console.log(Math.toFixed(2)); //2.12
